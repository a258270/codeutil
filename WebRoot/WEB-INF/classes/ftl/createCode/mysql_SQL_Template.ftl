...
CREATE TABLE `${tabletop}${objectNameUpper}` (
	...
	<#list fieldList as var>
		<#if var[1] == 'Integer'>
		`${var[0]}` int(11) <#if var[8]	== '是'>NOT NULL</#if> COMMENT '${var[2]}',
		<#elseif var[1] == 'Double'>
		`${var[0]}` double <#if var[8] == '是'>NOT NULL</#if> COMMENT '${var[2]}',
		<#else>
		`${var[0]}` varchar(255) <#if var[8] == '是'>NOT NULL</#if> COMMENT '${var[2]}',
		</#if>
	</#list>
